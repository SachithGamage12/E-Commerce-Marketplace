...
<body class="font-chakra bg-gray-100">
  ...
  <a href="index.php">
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4 animate-fadeInUp">About Markets.lk</h1>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto animate-fadeInUp" style="animation-delay: 0.2s;">
                    Your trusted local marketplace for buying, selling, and discovering amazing deals.
                </p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <!-- Image -->
                <div class="animate-fadeInUp" style="animation-delay: 0.4s;">
                    <img src="images/image.png" alt="Markets Marketplace" class="about-image pulse-glow">
                </div>
                <!-- Content -->
                <div class="section-bg p-8 rounded-lg animate-fadeInUp" style="animation-delay: 0.6s;">
                    <h2 class="text-2xl font-semibold text-white mb-4">Our Story</h2>
                    <p class="text-gray-200 mb-4">
                        Markets.lk was founded with a vision to create a seamless and secure platform for Sri Lankans to buy and sell goods and services locally. Inspired by the vibrant community spirit of Sri Lanka, we aim to connect people, foster trust, and make trading effortless.
                    </p>
                    <p class="text-gray-200 mb-4">
                        From electronics and vehicles to jobs and real estate, Markets.lk offers a diverse range of categories to meet your needs. Our user-friendly interface, robust security measures, and dedicated support team ensure a smooth experience for all users.
                    </p>
                    <a href="sell.php" class="inline-block cyber-btn px-6 py-3 mt-4">Start Selling Now</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="section-bg p-8 rounded-lg animate-fadeInUp">
                    <h2 class="text-2xl font-semibold text-white mb-4">Our Mission</h2>
                    <p class="text-gray-200">
                        To empower Sri Lankans by providing a reliable, accessible, and innovative platform for buying and selling, fostering economic growth and community connections.
                    </p>
                </div>
                <div class="section-bg p-8 rounded-lg animate-fadeInUp" style="animation-delay: 0.2s;">
                    ...
                    <p class="text-gray-200">
                        To be the leading marketplace in Sri Lanka, known for trust, convenience, and a wide range of opportunities for every user.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="terms" class="py-16 bg-gray-50">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-gray-800 text-center mb-12 animate-fadeInUp">Terms & Conditions</h2>
            <div class="section-bg p-8 rounded-lg animate-fadeInUp" style="animation-delay: 0.2s;">
                <h3 class="text-xl font-semibold text-white mb-4">1. Acceptance of Terms</h3>
                <p class="text-gray-200 mb-4">
                    By accessing or using Markets.lk, you agree to be bound by these Terms & Conditions. If you do not agree, please do not use our services.
                </p>
                <h3 class="text-xl font-semibold text-white mb-4">2. User Responsibilities</h3>
                <p class="text-gray-200 mb-4">
                    - You must be at least 18 years old to use Markets.lk.<br>
                    - You are responsible for maintaining the confidentiality of your account and password.<br>
                    - All listings must comply with our policies and Sri Lankan laws.
                </p>
                <h3 class="text-xl font-semibold text-white mb-4">3. Prohibited Activities</h3>
                <p class="text-gray-200 mb-4">
                    - Posting fraudulent, misleading, or illegal content.<br>
                    - Engaging in harassment or abusive behavior.<br>
                    - Using Markets.lk for unauthorized commercial purposes.
                </p>
                <h3 class="text-xl font-semibold text-white mb-4">4. Content Ownership</h3>
                <p class="text-gray-200 mb-4">
                    You retain ownership of the content you post, but grant Markets.lk a non-exclusive license to display and promote your listings.
                </p>
                <h3 class="text-xl font-semibold text-white mb-4">5. Limitation of Liability</h3>
                <p class="text-gray-200 mb-4">
                    Markets.lk is not liable for any damages arising from the use of our platform, including but not limited to financial losses or disputes between users.
                </p>
                ...
                <h3 class="text-xl font-semibold text-white mb-4">7. Changes to Terms</h3>
                <p class="text-gray-200 mb-4">
                    Markets.lk may update these Terms & Conditions at any time. Continued use of the platform constitutes acceptance of the updated terms.
                </p>
    ...
    <!-- Footer Section (Reusing the modern footer from previous response) -->
